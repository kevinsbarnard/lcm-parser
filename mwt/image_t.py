...
class image_t(object):
    __slots__ = ["utime", "width", "height", "row_stride", "pixelformat", "size", "data"]
    ...
    def _encode_one(self, buf):
        buf.write(
            struct.pack(">qiiiii", self.utime, self.width, self.height, self.row_stride, self.pixelformat, self.size))
    ...
    def _decode_one(buf):
        self = image_t()
        self.utime, self.width, self.height, self.row_stride, self.pixelformat, self.size = struct.unpack(">qiiiii",
                                                                                                          buf.read(28))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x87ee4fe2deaf538d) & 0xffffffffffffffff
